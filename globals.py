"""
mf_globals.py [module]

Global variable initializations for the mudflat event coder

 SYSTEM REQUIREMENTS
 This program has been successfully run under Mac OS 10.10; it is standard Python 3.5
...
18-Mar-17:  Modified from PETRglobals.py
